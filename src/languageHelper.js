    ...
    constructor() {
        ...
        this.i18n = {
            de_DE: {
                ...
                ERR_TIME_WITHOUT_DATE: 'Die Option "time" kann nicht ohne die Option "date" verwendet werden',
            ...
            en_GB: {
                ...
                ERR_OPTIONS_INVALID: 'Options is not a "RecrasOptions" object',
                ERR_TIME_WITHOUT_DATE: 'Option "time" cannot be used without option "date"',
            ...
            nl_NL: {
                ...
                ERR_TIME_WITHOUT_DATE: 'Optie "time" kan niet gebruikt worden zonder optie "date"',
